...
def speed_up_video(input_video, output_video, speed_factor):
    ...
    print(f"1.25x video: {output_video}")
...
speedup_output_video = 'tello_flight_video_1.25x2.mp4'  # 1.25배속 동영상 파일 이름
...
# 1.25배속으로 동영상 변환
speed_up_video(output_video, speedup_output_video, 1.25)

# 동영상 경로 및 열기(파일경로:저장하고 싶은 위치)
file_path = r'C:\Users\son\Desktop\Drone_github\tello_flight_video_1.25x2.mp4'
